...
<body>
    ...
    <section class="retorno-falha">
    <div class="container">
        <h1>Erro no Pagamento</h1>
        <p>Ocorreu um erro ao processar seu pagamento. Por favor, tente novamente mais tarde ou entre em contato com nosso suporte.</p>
        
        <div class="detalhes-pedido">
            <h3>Detalhes do Pedido</h3>
            <ul>
                <li><strong>ID do Pedido:</strong> 123456789</li>
                <li><strong>Valor Tentado:</strong> R$ 250,00</li>
                <li><strong>Status:</strong> Erro no pagamento</li>
            </ul>
        </div>

        <div class="opcoes">
            <p>Você pode tentar finalizar a compra novamente ou voltar para a página principal:</p>

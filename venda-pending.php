...
<body>
    ...
    <section class="retorno-pendente">
    <div class="container">
        <h1>Pagamento Pendente</h1>
        <p>O pagamento está sendo processado. Por favor, aguarde enquanto verificamos o status do pagamento.</p>
        ...
        <div class="opcoes">
            <p>Você pode acompanhar o status do pagamento em sua conta ou voltar à nossa loja para continuar comprando:</p>
            <a href="index.php" class="btn btn-warning">Voltar à Loja</a>
            <a href="meus-pedidos.php" class="btn btn-info">Ver Meus Pedidos</a>
        </div>
    </div>
</section>
